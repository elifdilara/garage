  ...
  <body style="height:auto;background-color: #fff">
    ...
    <div class="cover-container d-flex h-100 w-100 p-3 mx-auto flex-column" > 
        ...
        <main role="main" class="inner cover w-100">
            ...
            <p class="lead" style="text-align:center;color: black">Welcome <?php echo $_SESSION['name'];?>!</p>

            <form action="homeuser.php" method="post" > 

                <div class="form-group text-left">
                    <label for="Vehicle" style="color: black">Vehicle Plate Number</label>
                    <?php
                ...
                <div class="form-group text-left">
                    <label for="booking" style="color: black">Choose a type of booking
                    ...
                    <select type="text" class="form-control" id="booking" name="booking" placeholder="Choose a type of booking" onchange="fillTimeSelect()" required>
                        <option value="" selected style="color: black">Choose a type of booking</option>
                ...
                <div class="form-group text-left">
                    <label for="comment" style="color: black">Comments</label>
                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    <caption style="color: black">List of your appointments</caption>
                    <thead>
                      <tr>
                        <th scope="col" style="color: #858080">Booking number</th>
                        <th scope="col" style="color: #858080">Booking date</th>
                        <th scope="col" style="color: #858080">Booking type</th>
                        <th scope="col" style="color: #858080">Time</th>
                        <th scope="col" style="color: #858080">Status</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php    
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<tr><th scope='row' style='color: #858080'>" . 
                               $row["id"]  . "</th>";
                          ...
                          echo "<td style='color: #858080'>" . $AppDateResult . "</td>";
                          ...
                          while($row2 = mysqli_fetch_assoc($resultTypeApp)) {
                            ...
                            if ($row2["id"] == $row["type_app_id"]) {
                                ...
                                echo "<td style='color: #858080'>" . $row2["type"] . "</td>";
                                break;
                            }
                          ...
                          while($row2 = mysqli_fetch_assoc($resultStatus)) {
                            ...
                            if ($row2["id"] == $row["status_id"]) {
                                ...
                                echo "<td style='color: #858080'>" . $row2["status"] . "</td>";
                                break;
                            }
