...
<html lang="en">
  ...
  <body class="text-center" style="padding-top: 100px;padding-bottom: 100px;background-color: #fff">

    <div class="cover-container d-flex p-3 flex-column align-items-stretch">

    <form action="login.php" method="post">
        <h1 class="h3 mb-3 font-weight-normal" style="color: black">Please Log in</h1>
