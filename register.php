...
<html lang="en">
  ...
  <body style="height:auto;background-color: #fff">
    ...
    <form action="register.php" method="post">
        <h1 class="h3 mb-3 font-weight-normal text-center" style="color: black">Register</h1>
        <div class="form-group">
          <label for="email" style="color: black">Email address
        ...
        <div class="form-group">
            <label for="fullName" style="color: black">Full name
              <span class="asteriskField">
                *
              </span>
            </label>
        ...
        <div class="form-group">
          <label for="password1" style="color: black">Password
            <span class="asteriskField">
              *
            </span>
          </label>
        ...
        <div class="form-group">
            <label for="password2" style="color: black">Password
              <span class="asteriskField">
                *
              </span>
            </label>
        ...
        <div class="form-group">
            <label for="vehiclePlateNumber" style="color: black">Vehicle Plate Number
              <span class="asteriskField">
                *
              </span>
            </label>
        ...
        <div class="form-group">
            <label for="typeVehicle" style="color: black">Type of Vehicle
              <span class="asteriskField">
                *
              </span>
            </label>
        ...
        <div class="form-row">
            ...
            <div class="col-md-8 mb-12">
                <label for="makeVehicle" style="color: black">Make Vehicle
                  <span class="asteriskField">
                    *
                  </span>
                </label>
            ...
            <div class="col-md-4 mb-12">
                <label for="other" style="color: black">Other</label>
        ...
        <div class="form-group">
            <label for="engineType" style="color: black">Engine Type
              <span class="asteriskField">
                *
              </span>
            </label>
